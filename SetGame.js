...
var $author$project$SetGame$initModel = {cardsAtPlay: _List_Nil, chosenCards: _List_Nil, foundSets: _List_Nil, gameWon: false, notASet: false, numRightSets: 0, setAlreadyFound: false, totalNumSets: 0};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$SetGame$init = function (_v0) {
	return _Utils_Tuple2($author$project$SetGame$initModel, $elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$SetGame$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$SetGame$DealCards = function (a) {
	return {$: 'DealCards', a: a};
};
var $author$project$SetGame$NewGame = {$: 'NewGame'};
...
var $author$project$SetGame$removeCard = F2(
	function (x, cards) {
		removeCard:
		while (true) {
			if (!cards.b) {
				...
				if (_Utils_eq(x, c)) {
					...
					return A2(
						$elm$core$List$cons,
						c,
						A2($author$project$SetGame$removeCard, x, tail));
				}
			}
		}
	});
...
var $author$project$SetRules$getCard = F2(
	function (i, cards) {
		var _v0 = A2(
			$elm$core$Array$get,
			i,
			$elm$core$Array$fromList(cards));
		if (_v0.$ === 'Just') {
			var c = _v0.a;
			return c;
		} else {
...
var $author$project$SetRules$sameColorSet = F3(
	function (c1, c2, c3) {
		var _v0 = c3;
		var col3 = _v0.c;
		var _v1 = c2;
		...
		var _v2 = c1;
		var col1 = _v2.c;
		return _Utils_eq(col1, col2) && _Utils_eq(col2, col3);
	});
var $author$project$SetRules$sameNumberSet = F3(
	function (c1, c2, c3) {
		var _v0 = c3;
		var n3 = _v0.a;
		var _v1 = c2;
		...
		var _v2 = c1;
		var n1 = _v2.a;
		return _Utils_eq(n1, n2) && _Utils_eq(n2, n3);
	});
var $author$project$SetRules$samePatternSet = F3(
	function (c1, c2, c3) {
		var _v0 = c3;
		var p3 = _v0.d;
		var _v1 = c2;
		...
		var _v2 = c1;
		var p1 = _v2.d;
		return _Utils_eq(p1, p2) && _Utils_eq(p2, p3);
	});
var $author$project$SetRules$sameShapeSet = F3(
	function (c1, c2, c3) {
		var _v0 = c3;
		var s3 = _v0.b;
		var _v1 = c2;
		...
		var _v2 = c1;
		var s1 = _v2.b;
		return _Utils_eq(s1, s2) && _Utils_eq(s2, s3);
	});
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$SetRules$uniqueColorSet = F3(
	function (c1, c2, c3) {
		var _v0 = c3;
		var col3 = _v0.c;
		var _v1 = c2;
		...
		var _v2 = c1;
		var col1 = _v2.c;
		return (!_Utils_eq(col1, col2)) && ((!_Utils_eq(col2, col3)) && (!_Utils_eq(col1, col3)));
	});
var $author$project$SetRules$uniqueNumberSet = F3(
	function (c1, c2, c3) {
		var _v0 = c3;
		var n3 = _v0.a;
		var _v1 = c2;
		...
		var _v2 = c1;
		var n1 = _v2.a;
		return (!_Utils_eq(n1, n2)) && ((!_Utils_eq(n2, n3)) && (!_Utils_eq(n1, n3)));
	});
var $author$project$SetRules$uniquePatternSet = F3(
	function (c1, c2, c3) {
		var _v0 = c3;
		var p3 = _v0.d;
		var _v1 = c2;
		...
		var _v2 = c1;
		var p1 = _v2.d;
		return (!_Utils_eq(p1, p2)) && ((!_Utils_eq(p2, p3)) && (!_Utils_eq(p1, p3)));
	});
var $author$project$SetRules$uniqueShapeSet = F3(
	function (c1, c2, c3) {
		var _v0 = c3;
		var s3 = _v0.b;
		var _v1 = c2;
		...
		var _v2 = c1;
		var s1 = _v2.b;
		return (!_Utils_eq(s1, s2)) && ((!_Utils_eq(s2, s3)) && (!_Utils_eq(s1, s3)));
	});
var $author$project$SetRules$isSet = function (cards) {
	var c3 = A2($author$project$SetRules$getCard, 2, cards);
	var c2 = A2($author$project$SetRules$getCard, 1, cards);
	var c1 = A2($author$project$SetRules$getCard, 0, cards);
	var sameColor = A3($author$project$SetRules$sameColorSet, c1, c2, c3);
	var sameNumber = A3($author$project$SetRules$sameNumberSet, c1, c2, c3);
	var samePattern = A3($author$project$SetRules$samePatternSet, c1, c2, c3);
	var sameShape = A3($author$project$SetRules$sameShapeSet, c1, c2, c3);
	var uniqueColor = A3($author$project$SetRules$uniqueColorSet, c1, c2, c3);
	var uniqueNumber = A3($author$project$SetRules$uniqueNumberSet, c1, c2, c3);
	var uniquePattern = A3($author$project$SetRules$uniquePatternSet, c1, c2, c3);
	var uniqueShape = A3($author$project$SetRules$uniqueShapeSet, c1, c2, c3);
	var _v0 = _Utils_Tuple2(
		_Utils_Tuple2(sameNumber, sameShape),
		_Utils_Tuple2(sameColor, samePattern));
	if (_v0.a.a) {
		if (_v0.a.b) {
			if (_v0.b.a) {
				if (!_v0.b.b) {
				...
				if (_v0.b.b) {
					...
					var _v17 = _v0.a;
					var _v18 = _v0.b;
					return uniqueColor && uniquePattern;
				}
			}
		} else {
			if (_v0.b.a) {
				if (_v0.b.b) {
					...
					var _v19 = _v0.a;
					var _v20 = _v0.b;
					return uniqueShape && uniquePattern;
				}
			} else {
				if (!_v0.b.b) {
					var _v15 = _v0.a;
					var _v16 = _v0.b;
					return uniqueShape && (uniqueColor && uniquePattern);
				} else {
					var _v21 = _v0.a;
					var _v22 = _v0.b;
					return uniqueShape && uniqueColor;
				}
			}
		}
	} else {
		if (_v0.a.b) {
			if (_v0.b.a) {
				if (_v0.b.b) {
					...
					var _v23 = _v0.a;
					var _v24 = _v0.b;
					return uniqueNumber && uniquePattern;
				}
			} else {
				if (!_v0.b.b) {
					var _v13 = _v0.a;
					var _v14 = _v0.b;
					return uniqueNumber && (uniqueColor && uniquePattern);
				} else {
					var _v25 = _v0.a;
					var _v26 = _v0.b;
					return uniqueNumber && uniqueColor;
				}
			}
		} else {
			if (_v0.b.a) {
				if (!_v0.b.b) {
					var _v11 = _v0.a;
					var _v12 = _v0.b;
					return uniqueNumber && (uniqueShape && uniquePattern);
				} else {
					var _v27 = _v0.a;
					var _v28 = _v0.b;
					return uniqueNumber && uniqueShape;
				}
			} else {
				if (_v0.b.b) {
					var _v9 = _v0.a;
					var _v10 = _v0.b;
					return uniqueNumber && (uniqueShape && uniqueColor);
				} else {
					var _v29 = _v0.a;
					var _v30 = _v0.b;
					return uniqueNumber && (uniqueShape && (uniqueColor && uniquePattern));
				}
			}
		}
	}
};
var $author$project$SetGame$isUniqueSet = F2(
	function (newSet, foundSets) {
		isUniqueSet:
		while (true) {
			var sameSet = F2(
				function (x, foundSet) {
					if (!x.b) {
						...
						var head = x.a;
						var rest = x.b;
						return A2($elm$core$List$member, head, foundSet) && A2(sameSet, rest, foundSet);
					}
				});
			if (!foundSets.b) {
				return true;
				...
				var f = foundSets.a;
				var rest = foundSets.b;
				if (A2(sameSet, newSet, f)) {
					return false;
				} else {
					var $temp$newSet = newSet,
						$temp$foundSets = rest;
					newSet = $temp$newSet;
					foundSets = $temp$foundSets;
					continue isUniqueSet;
				}
			}
		}
	});
var $author$project$SetGame$onlyCards = function (gCards) {
	return A2(
		$elm$core$List$map,
		function (c) {
			return c.card;
...
var $author$project$SetGame$resetCardsAtPlay = function (cards) {
	if (!cards.b) {
		return _List_Nil;
	} else {
		var c = cards.a;
		...
		return A2(
			...
			_Utils_update(
				c,
				{chosen: false}),
			$author$project$SetGame$resetCardsAtPlay(tail));
	}
};
var $author$project$SetGame$threeCardUpdate = F2(
	function (model, card) {
		var chosenCards = $author$project$SetGame$onlyCards(
			A2($elm$core$List$cons, card, model.chosenCards));
		var isSet = $author$project$SetRules$isSet(chosenCards);
		var uniqueSet = A2($author$project$SetGame$isUniqueSet, chosenCards, model.foundSets);
		var updatedModel = isSet ? (uniqueSet ? _Utils_update(
			model,
			{
				cardsAtPlay: $author$project$SetGame$resetCardsAtPlay(model.cardsAtPlay),
				chosenCards: _List_Nil,
				foundSets: A2($elm$core$List$cons, chosenCards, model.foundSets),
				notASet: false,
				numRightSets: model.numRightSets + 1,
		...
		return (updatedModel.numRightSets === 4) ? _Utils_Tuple2(
			_Utils_update(
				updatedModel,
				{gameWon: true}),
			$elm$core$Platform$Cmd$none) : _Utils_Tuple2(updatedModel, $elm$core$Platform$Cmd$none);
	});
var $author$project$SetGame$toggleCardHighlight = F2(
	function (x, cards) {
		toggleCardHighlight:
		while (true) {
			if (!cards.b) {
				...
				if (_Utils_eq(c, x)) {
					...
					x = $temp$x;
					cards = $temp$cards;
					continue toggleCardHighlight;
				} else {
					return A2(
						$elm$core$List$cons,
						c,
						A2($author$project$SetGame$toggleCardHighlight, x, tail));
				}
			}
		}
	});
var $author$project$SetGame$chooseCardUpdate = F2(
	function (model, card) {
		return (!A2($elm$core$List$member, card, model.chosenCards)) ? (($elm$core$List$length(model.chosenCards) <= 1) ? _Utils_Tuple2(
			_Utils_update(
				model,
				{
					cardsAtPlay: A2($author$project$SetGame$toggleCardHighlight, card, model.cardsAtPlay),
					chosenCards: A2(
						$elm$core$List$cons,
						_Utils_update(
							card,
			...
			$elm$core$Platform$Cmd$none) : A2($author$project$SetGame$threeCardUpdate, model, card)) : _Utils_Tuple2(
			_Utils_update(
				model,
				{
					cardsAtPlay: A2($author$project$SetGame$toggleCardHighlight, card, model.cardsAtPlay),
					chosenCards: A2($author$project$SetGame$removeCard, card, model.chosenCards)
				}),
...
var $author$project$SetRules$getCombinations = F2(
	function (k, set) {
		if (!k) {
			return _List_fromArray(
				[_List_Nil]);
			...
			if (!set.b) {
				...
				return _Utils_ap(
					A2(
						...
						A2($author$project$SetRules$getCombinations, k - 1, xs)),
					A2($author$project$SetRules$getCombinations, k, xs));
			}
		}
	});
var $author$project$SetRules$numSets = function (cards) {
	var allCombos = A2($author$project$SetRules$getCombinations, 3, cards);
	return $elm$core$List$length(
		A2(
			$elm$core$List$filter,
			$elm$core$Basics$eq(true),
			A2($elm$core$List$map, $author$project$SetRules$isSet, allCombos)));
};
var $author$project$SetRules$Card = F4(
	function (a, b, c, d) {
		return {$: 'Card', a: a, b: b, c: c, d: d};
	});
var $author$project$SetRules$Green = {$: 'Green'};
var $author$project$SetRules$Purple = {$: 'Purple'};
var $author$project$SetRules$Red = {$: 'Red'};
var $author$project$SetRules$colors = _List_fromArray(
	[$author$project$SetRules$Red, $author$project$SetRules$Purple, $author$project$SetRules$Green]);
...
var $author$project$SetRules$numbers = _List_fromArray(
	[1, 2, 3]);
var $author$project$SetRules$Outlined = {$: 'Outlined'};
var $author$project$SetRules$Solid = {$: 'Solid'};
var $author$project$SetRules$Striped = {$: 'Striped'};
var $author$project$SetRules$patterns = _List_fromArray(
	[$author$project$SetRules$Solid, $author$project$SetRules$Striped, $author$project$SetRules$Outlined]);
var $author$project$SetRules$Diamond = {$: 'Diamond'};
var $author$project$SetRules$Oval = {$: 'Oval'};
var $author$project$SetRules$Squiggle = {$: 'Squiggle'};
var $author$project$SetRules$shapes = _List_fromArray(
	[$author$project$SetRules$Oval, $author$project$SetRules$Squiggle, $author$project$SetRules$Diamond]);
var $author$project$SetRules$deck = A2(
				...
				return A2(
					...
					function (c) {
						return A2(
							$elm$core$List$map,
							function (p) {
								return A4($author$project$SetRules$Card, n, s, c, p);
							},
							$author$project$SetRules$patterns);
					},
					$author$project$SetRules$colors);
			},
			$author$project$SetRules$shapes);
	},
	$author$project$SetRules$numbers);
var $author$project$SetGame$gameCards = function (cards) {
	return A2(
		$elm$core$List$map,
		function (c) {
			return {card: c, chosen: false};
		},
		cards);
};
...
var $author$project$SetGame$shuffleDeck = $elm_community$random_extra$Random$List$shuffle(
	$author$project$SetGame$gameCards($author$project$SetRules$deck));
...
var $author$project$SetGame$update = F2(
	function (msg, model) {
		update:
		while (true) {
			switch (msg.$) {
				case 'NewGame':
					return _Utils_Tuple2(
						$author$project$SetGame$initModel,
						A2($elm$random$Random$generate, $author$project$SetGame$DealCards, $author$project$SetGame$shuffleDeck));
				case 'DealCards':
					var cards = msg.a;
					var gameDeck = A2($elm$core$List$take, 12, cards);
					var numSets = $author$project$SetRules$numSets(
						$author$project$SetGame$onlyCards(gameDeck));
					if ((numSets >= 4) && (numSets <= 6)) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{cardsAtPlay: gameDeck, totalNumSets: numSets}),
							$elm$core$Platform$Cmd$none);
					} else {
						var $temp$msg = $author$project$SetGame$NewGame,
							$temp$model = $author$project$SetGame$initModel;
						msg = $temp$msg;
						model = $temp$model;
						continue update;
					}
				default:
					var card = msg.a;
					return A2($author$project$SetGame$chooseCardUpdate, model, card);
			}
		}
	});
var $elm$html$Html$button = _VirtualDom_node('button');
var $author$project$SetGame$ChooseCard = function (a) {
	return {$: 'ChooseCard', a: a};
};
...
var $timjs$elm_collage$Collage$Smooth = {$: 'Smooth'};
var $author$project$SetGame$cardHeight = 150;
var $author$project$SetGame$cardWidth = 200;
...
var $author$project$SetGame$highlightColor = A3($avh4$elm_color$Color$rgb255, 227, 238, 255);
var $author$project$SetGame$roundedAngle = 20;
...
var $author$project$SetGame$drawCardOutline = function (card) {
	var fillStyle = card.chosen ? $timjs$elm_collage$Collage$uniform($author$project$SetGame$highlightColor) : $timjs$elm_collage$Collage$transparent;
	return A2(
		...
		_Utils_Tuple2(
			...
			_Utils_update(
				...
				{cap: $timjs$elm_collage$Collage$Round, join: $timjs$elm_collage$Collage$Smooth})),
		A3($timjs$elm_collage$Collage$roundedRectangle, $author$project$SetGame$cardWidth, $author$project$SetGame$cardHeight, $author$project$SetGame$roundedAngle));
};
...
var $author$project$SetGame$green = A3($avh4$elm_color$Color$rgb255, 75, 166, 90);
var $author$project$SetGame$purple = A3($avh4$elm_color$Color$rgb255, 79, 3, 166);
var $author$project$SetGame$red = A3($avh4$elm_color$Color$rgb255, 235, 64, 52);
var $author$project$SetGame$getColor = function (color) {
	switch (color.$) {
		case 'Red':
			return $author$project$SetGame$red;
		case 'Purple':
			return $author$project$SetGame$purple;
		default:
			return $author$project$SetGame$green;
	}
};
...
var $author$project$SetGame$lightGreen = A4($avh4$elm_color$Color$rgba, 0.29, 0.65, 0.35, 0.3);
var $author$project$SetGame$lightPurple = A4($avh4$elm_color$Color$rgba, 0.31, 0.01, 0.65, 0.3);
var $author$project$SetGame$lightRed = A4($avh4$elm_color$Color$rgba, 0.92, 0.25, 0.2, 0.3);
var $author$project$SetGame$getStripedColor = function (color) {
	switch (color.$) {
		case 'Red':
			return $author$project$SetGame$lightRed;
		case 'Purple':
			return $author$project$SetGame$lightPurple;
		default:
			return $author$project$SetGame$lightGreen;
	}
};
...
var $author$project$SetGame$drawShape = F3(
	function (s, c, p) {
		var lineStyle = A2(
			$timjs$elm_collage$Collage$solid,
			$timjs$elm_collage$Collage$semithick,
			$timjs$elm_collage$Collage$uniform(
				$author$project$SetGame$getColor(c)));
		var fillStyle = function () {
			switch (p.$) {
				case 'Outlined':
					return $timjs$elm_collage$Collage$transparent;
				case 'Striped':
					return $timjs$elm_collage$Collage$uniform(
						$author$project$SetGame$getStripedColor(c));
				default:
					return $timjs$elm_collage$Collage$uniform(
						$author$project$SetGame$getColor(c));
			}
		...
		switch (s.$) {
			case 'Oval':
				return A2(
					$timjs$elm_collage$Collage$styled,
					_Utils_Tuple2(fillStyle, lineStyle),
					$timjs$elm_collage$Collage$circle(25));
			case 'Squiggle':
				return A2(
					...
					A2(
						$timjs$elm_collage$Collage$styled,
						_Utils_Tuple2(fillStyle, lineStyle),
						$timjs$elm_collage$Collage$triangle(40)));
			default:
				return A2(
					$timjs$elm_collage$Collage$rotate,
					...
					A2(
						$timjs$elm_collage$Collage$styled,
						_Utils_Tuple2(fillStyle, lineStyle),
						$timjs$elm_collage$Collage$square(35)));
		}
	});
...
var $author$project$SetGame$drawCard = function (card) {
	var space = A2($timjs$elm_collage$Collage$Layout$spacer, 5, 0);
	var _v0 = card.card;
	var n = _v0.a;
	var s = _v0.b;
	var c = _v0.c;
	var p = _v0.d;
	var shape = A3($author$project$SetGame$drawShape, s, c, p);
	var multiplyShape = function (x) {
		return (!x) ? _List_Nil : A2(
			$elm$core$List$cons,
			shape,
			multiplyShape(x - 1));
	};
	var design = $timjs$elm_collage$Collage$Layout$horizontal(
		A2(
	...
	return A2(
		...
		$timjs$elm_collage$Collage$Layout$center(design),
		$author$project$SetGame$drawCardOutline(card));
};
...
var $author$project$SetGame$viewCard = function (card) {
	return $timjs$elm_collage$Collage$Render$svg(
		$author$project$SetGame$drawCard(card));
};
var $author$project$SetGame$cardGrid = function (cards) {
	return A2(
		$elm$core$List$map,
		function (c) {
			return A2(
				...
				_List_fromArray(
					[
						...
						$author$project$SetGame$ChooseCard(c))
					]),
				_List_fromArray(
					[
						$author$project$SetGame$viewCard(c)
					]));
		},
		cards);
};
...
var $author$project$SetGame$foundSetsGrid = function (foundSets) {
	var gameCardSets = $elm$core$List$reverse(
		A2($elm$core$List$concatMap, $author$project$SetGame$gameCards, foundSets));
	return A2(
		$elm$core$List$map,
		function (c) {
			return A2(
...
var $author$project$SetGame$setMessage = function (model) {
	var fourSets = 'Find 4 SETs to win! ';
	return model.gameWon ? 'Game, SET, match!' : (model.setAlreadyFound ? (fourSets + 'SET already found.') : (model.notASet ? (fourSets + 'Not a SET.') : fourSets));
};
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $elm$core$Debug$toString = _Debug_toString;
var $author$project$SetGame$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$SetGame$NewGame),
				...
				_List_fromArray(
					[
						$elm$html$Html$text('ELM SET GAME')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('two-grid')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$SetGame$setMessage(model))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
								...
								$author$project$SetGame$cardGrid(model.cardsAtPlay))
							])),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										'You have found ' + ($elm$core$Debug$toString(model.numRightSets) + ' of 4 SETs'))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
								...
								$author$project$SetGame$foundSetsGrid(model.foundSets))
							]))
					]))
			]));
};
var $author$project$SetGame$main = $elm$browser$Browser$element(
	{init: $author$project$SetGame$init, subscriptions: $author$project$SetGame$subscriptions, update: $author$project$SetGame$update, view: $author$project$SetGame$view});
_Platform_export({'SetGame':{'init':$author$project$SetGame$main(
